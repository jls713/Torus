...
bool Torus::read_ebf(const string filename, const string torusname) {
  ...
  if(ebf::ContainsKey(filename,"/"+torusname+"/actions")) {
    ...
    int n1_tmp[nSn], n2_tmp[nSn], n3_tmp[nSn];
    double Sn_tmp[nSn], dSn1[nSn], dSn2[nSn], dSn3[nSn];
    ...
    GenPar SN,S1,S2,S3;
    SN.read(n1_tmp,n2_tmp,n3_tmp,Sn_tmp,nSn);
    S1.read(n1_tmp,n2_tmp,n3_tmp,dSn1,nSn);
    S2.read(n1_tmp,n2_tmp,n3_tmp,dSn2,nSn);
    S3.read(n1_tmp,n2_tmp,n3_tmp,dSn3,nSn);
    AngPar AP(S1,S2,S3);
    if(got_PT)
